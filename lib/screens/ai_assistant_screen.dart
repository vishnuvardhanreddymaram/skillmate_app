// Cleaned version of AiAssistantScreen without duplicate definitions
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          IconButton(icon: const Icon(Icons.vpn_key_rounded), onPressed: _showKeyDialog),
        ],
      ),
      body: Column(
        children: [
          ...
          if (_isTyping)
            const Padding(padding: EdgeInsets.all(8.0), child: Text("AI is thinking...", style: TextStyle(fontStyle: FontStyle.italic))),
          _buildInput(),
        ],
      ),
    );
